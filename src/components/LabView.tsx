...
export default function LabView({ onBookDemoClick }: LabViewProps) {
  ...
  return (
    <div className="relative z-10 bg-brand-dark">
      ...
      <div className="absolute top-20 left-10 h-80 w-80 rounded-full bg-[#0052FF]/2 blur-3xl -z-10" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-[68px] leading-[0.85] text-slate-900 uppercase heading-inter-heavy">
              Reduce Repetitive <br /><span className="text-[#0052FF]">Lab Enquiries</span>
            </h1>
            ...
            <div className="rounded-3xl border border-black/10 bg-white p-6 shadow-xl aspect-[9/16] w-full max-w-[400px] mx-auto flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="absolute top-0 inset-x-0 h-8 bg-slate-50 border-b border-black/5 px-4 flex items-center justify-between">
                <div className="flex items-center gap-1">
                  <span className="text-[9px] font-bold text-slate-600 uppercase tracking-widest">LAB WORKFLOW SIMULATOR</span>
                </div>
              ...
              <div className="flex-1 h-96 overflow-y-auto pt-10 pb-4 space-y-4 flex flex-col justify-end">
                {selectedScenario === null ? (
                  <div className="text-center p-6 space-y-4 my-auto">
                    ...
                    <div>
                      <h4 className="font-display text-sm font-extrabold text-slate-900 uppercase tracking-wide">Click a laboratory question</h4>
                      <p className="text-xs text-slate-500 mt-1 font-semibold leading-relaxed">Select any common diagnostic query to see how the Lab Assistant automates replies live.</p>
                    </div>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {simulatedChat.map((msg, idx) => (
                      ...
                      >
                        {msg.sender === 'system' ? (
                          ...
                          <>
                            <span className="text-[9px] text-slate-500 mb-0.5 tracking-wider font-bold uppercase">{msg.sender === 'patient' ? 'INBOUND PATIENT' : 'VOXABOT LAB'} • {msg.time}</span>
                    ...
                    {typingState && (
                      <div className="self-start flex flex-col max-w-[85%] items-start animate-pulse mr-auto">
                        <span className="text-[9px] text-slate-500 mb-0.5 font-bold uppercase">VOXABOT LAB AI TYPING...</span>
              ...
              <div className="border-t border-black/5 pt-4">
                <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest mb-2">Simulated Laboratory Questions</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="rounded-3xl border border-dashed border-blue-500/20 bg-blue-50/20 p-6 md:p-8 flex flex-col justify-between shadow-sm"
            >
              <div>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-2">
              <h4 className="font-display text-base font-extrabold text-rose-950 uppercase tracking-wide">Strict Pathology Communication Boundary</h4>
